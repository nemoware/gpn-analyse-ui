...
async function generateConclusion(audit) {
  ...
  conclusion.intro = `В целях исполнения решения Совета директоров ОАО «Газпром» от 05.09.2013 г. № 2243, поручения начальника Департамента по управлению имуществом и корпоративными отношениями ОАО «Газпром» Михайловой Е.В. от 25.11.2013 г. № 01/05-9226, руководством ПАО «Газпром нефть» (далее – «Компания», «ГПН») было принято решение о проведении Департаментом корпоративного и проектного сопровождения ГПН (далее – «ДКиПС») в период ${moment(
    ...
    'MMMM YYYY'
  )} аудита практики корпоративного управления (далее – «Корпоративный аудит») в дочерних обществах (далее – «ДО») Компании, в частности ${
    audit.subsidiaryName
  } (далее – «Общество»).
...
В период с ${moment(audit.createDate).format('DD.MM.YYYY')} г. по ${
  ...
  } г. на основании обращения Заместителя генерального директора по правовым и корпоративным вопросам ПАО «Газпром нефть» Илюхиной Е.А. № НК-ХХ от ХХ.ХХ.ХХХХ г. (Приложение № 1) ДКиПС был проведен Корпоративный аудит ${
    audit.subsidiaryName
  }.
...
2.2. полную проверку представленной документации на предмет полноты, достоверности, правильности оформления (соответствие объема представленной документации электронной базе ДКиПС).
...
По результатам проведенного Корпоративного аудита подготовлен настоящий отчет, содержащий основные результаты Корпоративного аудита, а также рекомендации ДКиПС относительно усовершенствования практики корпоративного управления ${
    audit.subsidiaryName
  }.\n`;
  conclusion.shortSummary = `Ниже перечислены наиболее существенные сильные стороны и недостатки системы корпоративного управления ${audit.subsidiaryName} согласно результатам Корпоративного аудита, проведенного ДКиПС.\n`;
